...
plt.axhline(y = 21.350085881691797, color = 'r', linestyle="dashdot")
plt.axhline(y = 3.1838476698933125, color = 'g', linestyle="dashdot")
plt.axhline(y = 5.1360739595864935, color = 'b', linestyle="dashdot")
plt.axhline(y = 43.304194169033686, color = 'violet', linestyle="dashdot")
plt.axhline(y = 19.604335719169143, color = 'gray', linestyle="dashdot")
