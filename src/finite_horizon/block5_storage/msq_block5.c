...
void *block5() 
{
    ...
    int numberOfServers = SERVERS_FIVE_F1; /* current number of servers */
    ...
    //printf("\n[BLOCCO5]: Terminated, waiting for the orchestrator...\n");
    /*
    oper.sem_num = 4;
    oper.sem_op = -1;
    oper.sem_flg = 0;
