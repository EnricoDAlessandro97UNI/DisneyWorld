...
plt.axhline(y = 4.521384463647584, color = 'r', linestyle="dashdot", label='Theorical Mean Class1')
plt.axhline(y = 19.320284987286822, color = 'g', linestyle="dashdot", label='Theorical Mean Class1')
...
plt.tight_layout()
#plt.show()
plt.savefig('node_pop_F2_block4_classes.png')
