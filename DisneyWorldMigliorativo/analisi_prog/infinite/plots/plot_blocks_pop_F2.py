...
plt.axhline(y = 19.07315219608237, color = 'r', linestyle="dashdot")
plt.axhline(y = 1.7401729356619695, color = 'g', linestyle="dashdot")
plt.axhline(y = 2.186497231182548, color = 'b', linestyle="dashdot")
