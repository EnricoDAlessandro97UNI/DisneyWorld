...
#define SERVERS_THREE_F1 4  /* number of servers time slot 1 */
#define SERVERS_THREE_F2 3  /* number of servers time slot 2 */
#define M3 10
...
void block3() 
{
    ...
    if (changeConfig == 1) {
        ...
        if (e != -1) {
            ...
            update_next_event(3, INFINITY, 0, event[e].disabled);
        }
